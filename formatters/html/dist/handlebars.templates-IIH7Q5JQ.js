...
`},5:function(n,l,a,f,r){var e,o=n.lookupProperty||function(u,s){if(Object.prototype.hasOwnProperty.call(u,s))return u[s]};return(e=o(a,"each").call(l??(n.nullContext||{}),l!=null?o(l,"results"):l,{name:"each",hash:{},fn:n.program(6,r,0),inverse:n.noop,data:r,loc:{start:{line:15,column:2},end:{line:26,column:11}}}))!=null?e:""},6:function(n,l,a,f,r){var e,o=n.lambda,u=n.escapeExpression,s=l??(n.nullContext||{}),i=n.lookupProperty||function(c,t){if(Object.prototype.hasOwnProperty.call(c,t))return c[t]};return`    <div class="result">
      <h2 class="result-id">
        <a href="`+u(o(l!=null?i(l,"ref"):l,l))+`">
          `+((e=i(a,"if").call(s,l!=null?i(l,"package"):l,{name:"if",hash:{},fn:n.program(7,r,0),inverse:n.noop,data:r,loc:{start:{line:19,column:10},end:{line:19,column:85}}}))!=null?e:"")+'<span translate="no">'+u(o(l!=null?i(l,"title"):l,l))+"</span> <small>("+u(o(l!=null?i(l,"type"):l,l))+`)</small>
        </a>
      </h2>
`+((e=i(a,"each").call(s,l!=null?i(l,"excerpts"):l,{name:"each",hash:{},fn:n.program(9,r,0),inverse:n.noop,data:r,loc:{start:{line:22,column:8},end:{line:24,column:17}}}))!=null?e:"")+`    </div>
`},7:function(n,l,a,f,r){var e=n.lookupProperty||function(o,u){if(Object.prototype.hasOwnProperty.call(o,u))return o[u]};return"<small><code>"+n.escapeExpression(n.lambda(l!=null?e(l,"package"):l,l))+"</code></small><br>"},9:function(n,l,a,f,r){var e;return'          <p class="result-elem">'+((e=n.lambda(l,l))!=null?e:"")+`</p>
`},11:function(n,l,a,f,r){var e,o=n.lookupProperty||function(u,s){if(Object.prototype.hasOwnProperty.call(u,s))return u[s]};return((e=(o(a,"isArray")||l&&o(l,"isArray")||n.hooks.helperMissing).call(l??(n.nullContext||{}),l!=null?o(l,"results"):l,{name:"isArray",hash:{},fn:n.program(12,r,0),inverse:n.program(14,r,0),data:r,loc:{start:{line:28,column:2},end:{line:34,column:14}}}))!=null?e:"")+`
...
`},14:function(n,l,a,f,r){var e,o=n.lookupProperty||function(u,s){if(Object.prototype.hasOwnProperty.call(u,s))return u[s]};return(e=o(a,"if").call(l??(n.nullContext||{}),l!=null?o(l,"value"):l,{name:"if",hash:{},fn:n.program(15,r,0),inverse:n.program(17,r,0),data:r,loc:{start:{line:30,column:2},end:{line:34,column:2}}}))!=null?e:""},15:function(n,l,a,f,r){var e,o=n.lookupProperty||function(u,s){if(Object.prototype.hasOwnProperty.call(u,s))return u[s]};return"    <p>Invalid search: "+n.escapeExpression((e=(e=o(a,"errorMessage")||(l!=null?o(l,"errorMessage"):l))!=null?e:n.hooks.helperMissing,typeof e=="function"?e.call(l??(n.nullContext||{}),{name:"errorMessage",hash:{},data:r,loc:{start:{line:31,column:23},end:{line:31,column:39}}}):e))+`.</p>
`},17:function(n,l,a,f,r){return`    <p>Please type something into the search bar to perform a search.</p>
